...
const WishList: React.FC<Props> = ({ navigation }) => {
  ...
  const handleClearWishlist = async () => {
    try {
      ...
      if (res.data && (res.data.message === "successfully removed!" || res.data.message === "Successfully removed!")) {
        setWishlistItems([]);
      ...
      Alert.alert('Error', err?.response?.data?.message || 'Failed to clear wishlist.');
    } finally {
      setClearLoading(false);
    }
  };
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.innerContainer}>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <CustomText style={styles.emptyText}>Your wishlist is empty</CustomText>
          }
        />
