    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#f6f8fa' }}>
                ...
                <View style={styles.sellerCard}>
                    ...
                    <View style={{ flex: 1, marginLeft: 10 }}>
                        ...
                        <View style={styles.ratingRow}>
                            <VectorIcon type="FontAwesome" name="star" size={14} color="#FFA500" />
                        ...
                        <Text style={styles.ordersText}>{seller?.orders_count ?? 0} Orders</Text>
                    </View>
                    <TouchableOpacity
                        style={styles.chatBtn}
                        onPress={() => setChatModal(true)}
                    >
                        <VectorIcon type="MaterialIcons" name="chat" size={18} color="#333" />
            ...
            <View style={styles.filterRow}>
                ...
                >
                    <VectorIcon type="MaterialIcons" name="category" size={18} color="#888" />
                    <Text style={styles.filterButtonText}>
                        {selectedCategory ? selectedCategory : 'Category'}
                    </Text>
                    <VectorIcon type="Entypo" name="chevron-down" size={16} color="#888" />
                </TouchableOpacity>
                <TouchableOpacity
                    style={styles.filterButton}
                    onPress={() => setSortModal(true)}
                >
                    <VectorIcon type="MaterialIcons" name="sort" size={18} color="#888" />
                    <Text style={styles.filterButtonText}>
            ...
            <Modal animationType="slide" transparent={true} visible={chatModal}>
                <View style={styles.modalContainer}>
                    <View style={styles.chatModalContent}>
                        ...
                        >
                            <VectorIcon type="Ionicons" name="close" size={24} color="#333" />
                        </TouchableOpacity>
